// app/components/dashboard/RateLimitDashboard.tsx
"use client";
...
export default function RateLimitDashboard() {
  ...
  const resetRateLimit = async () => {
    ...
    try {
      const response = await fetch("/api/rate-limits/reset", {
        method: "POST",
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-montserrat"
          />
          <button
            onClick={fetchStatus}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-4 rounded shadow">
                ...
                <div
                  className={`text-xl font-bold ${
                    rateLimit.isBlocked ? "text-red-600" : "text-green-600"
                  }`}
                >
              ...
              <div className="bg-white p-4 rounded shadow">
                <div className="text-sm text-gray-500">Reset In</div>
