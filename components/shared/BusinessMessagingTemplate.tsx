      ...
      <div className=" mx-auto px-4">
        <div className="flex flex-col gap-12 items-center max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="relative w-[90vw] md:w-full max-w-5xl mx-auto"
          >
            ...
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden px-5 shadow-2xl shadow-[#00F0FF]/20"
            >
              ...
              <div className="relative overflow-hidden">
                <motion.video
                  ...
                  className="max-w-5xl h-auto w-full scale-[1.03] -translate-y-1"
                  style={{
