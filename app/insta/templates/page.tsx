...
export default function TemplatesPage() {
  ...
  // Load initial templates and subscription info
  useEffect(() => {
    ...
    (username: string) => {
      ...
      if (account && account.instagramId) {
        ...
        toast({
          ...
          description: "This Instagram account is not properly connected",
          duration: 3000,
          variant: "destructive",
        });
      }
  ...
  const handleUpdateTemplate = useCallback(async (template: TemplateType) => {
      ...
      <div className="container mx-auto p-2 md:px-4 py-8">
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {/* Media Selection */}
                {(!editingTemplate ||
                  (editingTemplate && newTemplate.accountUsername)) && (
                  <div className="space-y-4">
                ...
                >
                  <div className="flex-1">
                    <p className="font-medium mb-1">
                      Require Follow Before Link
                    </p>
                    <p className={`text-sm ${themeStyles.textMuted}`}>
                      Send a DM asking to follow you before they get the link
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-start w-full gap-5">
                    ...
                    ).map((trigger: string, index: number) => (
                      <div key={index} className="space-y-2">
                        <div className="flex justify-between">
                          <Label
                  ...
                  disabled={
                    ...
                    (editingTemplate
                      ...
                      : !newTemplate.name ||
                        ...
                        newTemplate.reply.some(
                          (r: string) => r.trim() === ""
                        ) ||
                        newTemplate.triggers.length === 0 ||
                        newTemplate.triggers.some(
                          (t: string) => t.trim() === ""
                        ) ||
        ...
        <div className="mb-6">
          <p className={themeStyles.textMuted}>
            ...
            {totalTemplates ? totalTemplates : "all"} templates
          </p>
        </div>
