...
> = {
  ...
  "chatbot-customer-support": {
    ...
    inclusions: [
      { label: "24/7 support", isIncluded: true },
      { label: "Custom responses", isIncluded: true },
      { label: "Multi-language support", isIncluded: true },
      { label: "Analytics dashboard", isIncluded: false },
    ],
  },
  // "chatbot-e-commerce": {
  ...
  "chatbot-education": {
    ...
    inclusions: [
      ...
      { label: "Resource suggestions", isIncluded: true },
      { label: "Video and audio integration", isIncluded: true },
    ],
  },
  ...
  //   },
  //   inclusions: [
  //     { label: "Sentiment analysis", isIncluded: true },
  //     { label: "Handle Unanswred Calls", isIncluded: true },
  //     { label: "Send Info On WhatsApp", isIncluded: true },
  //     { label: "Advanced analytics", isIncluded: true },
  //   ],
  // },
  //   "ai-agent-e-commerce": {
  //     productId: "ai-agent-e-commerce",
  //     name: "E-Commerce AI Agent",
  //     video: "/assets/congratulation.webm",
  //     icon: "ShoppingCartIcon",
  //     price: 2299,
  ...
  //     },
  //     inclusions: [
  //       { label: "Upsell recommendations", isIncluded: true },
  //       { label: "Dynamic pricing suggestions", isIncluded: true },
  //       { label: "Customer feedback analysis", isIncluded: true },
  //       { label: "Integration with CRM", isIncluded: true },
  //     ],
  //   },

  //   // Website Templates
  //   "template-pathology": {
  //     productId: "template-pathology",
  //     name: "Pathology Website Template",
  //     video: "/assets/congratulation.webm",
  //     icon: "AmbulanceIcon",
  //     price: 499,
  ...
  //     },
  //     inclusions: [
  //       { label: "Appointment scheduling", isIncluded: true },
  //       { label: "Responsive design", isIncluded: true },
  //       { label: "Customizable sections", isIncluded: true },
  //       { label: "SEO optimization", isIncluded: true },
  //     ],
  //   },
  //   "template-saas": {
  //     productId: "template-saas",
  //     name: "SaaS Website Template",
  //     video: "/assets/congratulation.webm",
  //     icon: "Building2Icon",
  //     price: 699,
  ...
  //     },
  //     inclusions: [
  //       { label: "Feature showcase", isIncluded: true },
  //       { label: "Subscription integration", isIncluded: true },
  //       { label: "Custom forms", isIncluded: true },
  //       { label: "Advanced analytics", isIncluded: true },
  //     ],
  //   },
};
